  ...
  <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media();  ?>/img/avatarUsuario.png" alt="User Image">
      ...
      <ul class="app-menu">
          <li>
              <a class="app-menu__item active" href="<?= base_url() ?>dashboard">
